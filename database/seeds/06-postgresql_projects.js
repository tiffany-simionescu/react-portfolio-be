      ...
      return knex('postgresql_projects').insert([
        {
          ...
          postgresql_project_description: "An NFL Fantasy Football Trade Anaylzer is to help a fan to build their ultimate fantasy league, by making the optinmal trades to win their fantasy competitions. The back end was built using Express, NodeJS, PostgreSQL, SQLite3 and Knex.",
