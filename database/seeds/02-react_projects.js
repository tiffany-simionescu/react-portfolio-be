    ...
    .then(function () {
      return knex('react_projects').insert([
        ...
        },
        {
          ...
          react_project_description: "An NFL Fantasy Football Trade Analyzer is to help a fan to build their ultimate fantasy league, by making the optimal trades to win their fantasy competitions. The front end was built using React, Material-UI, LESS, Styled-Components, Redux, and Heroku.",
