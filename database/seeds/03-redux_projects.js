    ...
    .then(function () {
      return knex('redux_projects').insert([
        ...
        },
        {
          ...
          redux_project_description: "An NFL Fantasy Football Trade Anaylzer is to help a fan to build their ultimate fantasy league, by making the optinmal trades trades to win their fantasy competitions. The front end was built using React, Material-UI, LESS, CSS, Styled-Components, Redux, Heroku and  React-Router-Dom.",
