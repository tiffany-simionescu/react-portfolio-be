    ...
    .then(function () {
      return knex('redux_projects').insert([
        ...
        },
        {
          ...
          redux_project_description: "An NFL Fantasy Football Trade Analyzer that helps a fan to build their ultimate fantasy league by making the optimal trades to win their fantasy competitions. Tech used: React, Material-UI, LESS, Styled-Components, Redux, and Heroku.",
